...
#define vect_128_store_native(_store_kind, _memb_kind, _dest, _m)  vect_128_## _store_kind ##_scalr((__m128i *)_dest, _m)
#define vect_128_load_native(_load_kind, _memb_kind, _sr)   vect_128_## _load_kind ## _scalr((__m128i *)(_sr))
